...
public class PolyLineEvent extends EditAnnotEvent {

    public PolyLineEvent(int eventType, PolyLineUndoItem undoItem, PolyLine polyLine, PDFViewCtrl pdfViewCtrl) {
        mType = eventType;
        mUndoItem = undoItem;
        mAnnot = polyLine;
    ...
    @Override
    public boolean add() {
        if (mAnnot == null || !(mAnnot instanceof PolyLine)) {
            return false;
        }
        PolyLine annot = (PolyLine) mAnnot;
        try {
            annot.setVertexes(((PolyLineAddUndoItem) mUndoItem).mVertexes);
    ...
    public boolean modify() {
        ...
        try {
            ...
            if (((PolyLineModifyUndoItem) mUndoItem).mVertexes != null) {
                annot.setVertexes(((PolyLineModifyUndoItem) mUndoItem).mVertexes);
            } else {
