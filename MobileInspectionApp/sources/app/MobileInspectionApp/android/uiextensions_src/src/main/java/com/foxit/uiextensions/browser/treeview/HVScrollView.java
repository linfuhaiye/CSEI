 ...
 * allowing it to be larger than the physical display.  A HVScrollView
 ...
 * takes care of its own scrolling, so does not require a HVScrollView, but
...
public class HVScrollView extends FrameLayout {
     ...
     * code that watches for focus changes initiated outside this HVScrollView
    ...
    /**
     * @return Returns true this crollView can be scrolled
     */
     ...
     * @param directionX the scroll direction: {@link View#FOCUS_LEFT}
